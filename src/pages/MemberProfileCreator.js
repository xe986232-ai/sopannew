...
import { creatorMembers } from "./MembersCreator.js";

// View Profile Member Sopan Creator — komponen baru, visual identik dengan tema template
...
const DetailRow = styled.div`${tw`flex items-center mt-3`}`;
...
export default () => {
  const { id } = useParams();
  const member = creatorMembers.find(m => m.id === id); // PLACEHOLDER
        ...
        <Container>
          <ContentWithPaddingXl>
            <NotFoundContainer>
              ...
              <SecondaryButton href="/creator/members">← Kembali ke Member Roster</SecondaryButton>
            </NotFoundContainer>
          </ContentWithPaddingXl>
        </Container>
      </AnimationRevealPage>
          ...
          <ProfileCard>
            ...
            <InfoContainer>
              ...
              <DetailRow>
                ...
                <DetailValue>
                  <a href={`https://www.tiktok.com/${member.socialMedia}`} target="_blank" rel="noreferrer" tw="text-primary-500 hover:text-primary-700">
                    {member.socialMedia}
                  </a>
              ...
              <DetailRow>
                ...
                <DetailValue>Sopan Creator</DetailValue>
              </DetailRow>
              ...
              <ButtonsRow>
                <PrimaryButton as="a" href="/creator/join">Join Sopan Creator</PrimaryButton>
                <SecondaryButton href="/creator/members">← Kembali ke Member Roster</SecondaryButton>
              </ButtonsRow>
            </InfoContainer>
          </ProfileCard>
